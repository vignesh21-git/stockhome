...
<p><div id="dropzone">
<form class="dropzone needsclick" id="demo-upload" action="index.php" Method = "POST">
...
class="_ab6-"color="#262626" fill="#262626" height="66" role="img" 
viewBox="0 0 97.6 77.3" width="55">
...
<!-- <textarea class="form-control" rows="2" placeholder="What you feel about your post?"
name="caption"></textarea> -->
</div>
</form>
</section>
<div class="d-grid gap-2 col-1 mx-auto">
  <button id="startUpload" class="btn btn-dark" type="button">upload </button>
</div>
<!-- <div class="text-center">
<input class="btn btn-primary" id ="" type="submit" value="upload" onClick="refreshPage();">
 <input class="btn btn-primary" id ="" type="submit" value="clear"> -->
<div>
</div>
<br>
